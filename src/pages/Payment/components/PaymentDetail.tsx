  ...
  const paymentStatusColumns = [  
    {  
      ...
      render: (status: string) => (  
        <Text strong style={{ color: status === "Authorizme" ? '#00474f' : 'inherit' }}>• {status}</Text>  
      ),  
      width: '20%',  
    },  
    {  
    ...
    <div>  
      ...
      >  
        ...
        <Row gutter={[0, 16]} style={{ marginTop: '20px' }}>  
          ...
          <Col span={24} style={{ background: '', padding: '10px', borderRadius: '5px', border: '1px solid #b7eb8f', marginBottom: '20px' }}>  
      ...
      <Card>  
        ...
        <Divider />  
        <Card title="JOB ORDER" headStyle={{ backgroundColor: '#00474f', color: 'white' }}>  
          <Table  
        ...
        <Divider />  
        <Card title="SLA JOB ORDER" headStyle={{ backgroundColor: '#00474f', color: 'white' }}>  
          <Table  
            columns={jobOrderColumns}  
            dataSource={jobOrderData}  
            pagination={false}  
        ...
        <Divider />  
        <Card title="SERVICE TOTAL" headStyle={{ backgroundColor: '#00474f', color: 'white' }}>  
        ...
        <Divider />  
        <Card title={<Row align="middle" gutter={16}><Col>VENDOR</Col></Row>} headStyle={{ backgroundColor: '#00474f', color: 'white' }} className="responsive-card">  
          <Row gutter={[24, 24]}>  
            <Col span={8} className="sm:w-full md:w-1/3 flex flex-col items-center p-5">  
              <div className="mb-3 ml-2">  
                <Tag color="#00474f" className="px-2 py-1 rounded-full">Active</Tag>  
              </div>  
              <div className="w-10 h-10 bg-gray-300 flex justify-center items-center rounded-full mb-2">  
                <Text strong className="text-2xl">D</Text>  
              </div>  
              <Text strong className="text-center">PT. PRISMA VISTA SOLUSI</Text>  
            </Col>  
